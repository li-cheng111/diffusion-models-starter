...
- 环境：Windows，Python 3.14.0，PyTorch 2.13.0+cu126，NVIDIA RTX 4060
  Laptop GPU。
- 命令：`python -m projects.project2_samplers.check_compat --ckpt projects/project1_ddpm/runs/exp_cifar10_advanced/ckpt/final.pt`、
  `python -m unittest discover -s projects/project2_samplers/tests -v`，以及两个 sampler 模块自测。
