...
This repository uses a monorepo layout: Project 1 and Project 2 are siblings
under ``projects/``. The explicit monorepo sibling is checked first. The
original sibling-repository discovery rules remain as fallbacks so this
directory can still be copied into a Classroom repository.
"""
...
DEFAULT_CANDIDATES = (
    "../project1_ddpm",  # selected monorepo layout
